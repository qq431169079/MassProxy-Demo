...
public class QueueDAO extends BaseRedisDAO {
    ...
    public void increaseCrawlCount(Integer count) {
    ...
    public Long getTaskCount() {
        return Long.valueOf(get(QueueConfig.TASK_COUNT));
    }

    public Long getOpenCount() {
        return Long.valueOf(get(QueueConfig.OPEN_COUNT));
    }

    public Long getOkCount() {
        return Long.valueOf(get(QueueConfig.OK_COUNT));
    }

    public Long getCrawlCount() {
        return Long.valueOf(get(QueueConfig.CRAWL_COUNT));
    }
}
